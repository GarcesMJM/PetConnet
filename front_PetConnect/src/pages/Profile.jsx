                        ...
                        <div class="col-12 col-lg-4 col-xl-3 order-2 order-lg-1">
                            <div class="card mb-3">
                                <div class="card-body text-center">
                                    <img src={usuario.foto_perfil} alt="Jassa Jas" class="img-fluid rounded-circle mb-2" width="128" height="128" />
                                ...
                                <div class="card-body h-100">
                                    ...
                                    {usuario.mascotas.map(mascota => (
                                        <div class="media" key={mascota.id}>
                                            <img src={usuario.foto_perfil} width="56" height="56" class="rounded-circle mr-3" alt={mascota.nombre} />
                                            <div class="media-body">
                                                <p class="mb-2"><strong>{usuario.usuario}</strong></p>
                                                <p>{mascota.nombre}</p>
